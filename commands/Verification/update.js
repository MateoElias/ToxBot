...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!message.member.roles.cache.some(r => r.name == 'Moderator')) return message.reply("You do not have permission to run this command")
        ...
        var data = await http(`https://verify.eryn.io/api/user/${GuildMember.id}`)
